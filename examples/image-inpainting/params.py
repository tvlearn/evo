...
mcar_parser = argparse.ArgumentParser(add_help=False)
mcar_parser.add_argument(
    "--clean_image",
    type=str,
...
mcar_parser.add_argument(
    "--percentage",
    type=int,
    help="Percentage of missing pixels",
    default=10,
)
...
viz_parser.add_argument(
    "--viz_every",
    type=int,
    help="Create visualizations every X'th epoch. Will be set to no_epochs if not specified.",
    default=1,
)
...
def get_args():
    parser = argparse.ArgumentParser(prog="MCAR Inpainting")
